...
?>
        ...
        <body class="vh-100 d-flex justify-content-center align-items-center" style="font-family: br hendrix">
            <div class="text-center" style="font-size: 20px;">
                <p style="color: #1dbf73; font-size: 60px;">Login Success!</p>
                <a href="studikasus-home.php" style="text-decoration: none; color: #1dbf73;">Continue</a> to Home page
            </div>
        </body>
                ...
                <section class="d-flex justify-content-center" style="height: 540px">
                    <div style="width: 330px; height: 300px">
                        <div>
                            ...
                            <div>
                                <button class="rounded-2 mb-1 p-1 border-0 text-light fw-bold d-flex w-100" style="background-color: #4267b2; height: 40px;">
                                    <img class="p-1 ms-2" src="source/fb.png" alt="logo faceboook" style="width: 30px; height: 30px">
                                ...
                                <button class="rounded-2 mt-2 mb-1 p-1 w-100 d-flex" style="background-color: white; border:1px solid #e4e5e7; height: 40px;">
                                    <img class="p-1 ms-2" src="source/google.png" alt="logo google" style="width: 30px; height: 30px">
                                    <div class="d-flex align-items-center" style="width: 280px; height: 30px; margin-left: 42px;">
                                        Continue with Google
                                    </div>
                                </button>
                                <button class="rounded-2 mt-2 mb-1 p-1 w-100 d-flex" style="background-color: white; border:1px solid #e4e5e7; height: 40px;">
                                    <img class="p-1 ms-2" src="source/apple.png" alt="logo google" style="width: 30px; height: 30px">
                        ...
                        <form action="" method="get">
                            ...
                            <input class="w-100 mb-1 mt-2 text-light rounded-2" type="submit" value="Continue" name="login" style="height: 40px; background-color: #1dbf73; border: none">
